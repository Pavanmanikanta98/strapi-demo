...
export interface ApiBusinessCaseBusinessCase
  ...
  attributes: {
    ClientName: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    ...
    > &
      Schema.Attribute.Private;
    ourSolution: Schema.Attribute.Blocks & Schema.Attribute.Required;
    problemStatement: Schema.Attribute.Text & Schema.Attribute.Required;
    process_flow: Schema.Attribute.Relation<
      'oneToOne',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    value_chain: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiProcessFlowPageProcessFlowPage
  extends Struct.SingleTypeSchema {
  collectionName: 'process_flow_pages';
  info: {
    displayName: 'Process Flow';
    pluralName: 'process-flow-pages';
    singularName: 'process-flow-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::process-flow-page.process-flow-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    steps: Schema.Attribute.Component<'shared.process-flow', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProcessFlowProcessFlow extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    business_case: Schema.Attribute.Relation<
      'oneToOne',
      'api::business-case.business-case'
    > &
      Schema.Attribute.Private;
...
export interface ApiValueChainPageValueChainPage
  extends Struct.SingleTypeSchema {
  collectionName: 'value_chain_pages';
  info: {
    displayName: 'Value Chain Page';
    pluralName: 'value-chain-pages';
    singularName: 'value-chain-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::value-chain-page.value-chain-page'
    > &
      Schema.Attribute.Private;
    page_content: Schema.Attribute.DynamicZone<
      ['shared.value-point', 'shared.testimonial']
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiValueChainValueChain extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    content: Schema.Attribute.DynamicZone<
      ['shared.testimonial', 'shared.value-point']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::process-flow-page.process-flow-page': ApiProcessFlowPageProcessFlowPage;
      'api::process-flow.process-flow': ApiProcessFlowProcessFlow;
      'api::value-chain-page.value-chain-page': ApiValueChainPageValueChainPage;
